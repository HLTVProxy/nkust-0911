<?php
    ...
    $menuData = array(
        "home" => array("name" => "回首頁",	"link" => "/mysite/nkust-0911/index.php"),
		"test01" => array("name" => "生日詢問表單", "link" => "/mysite/nkust-0911/test01"),
		"tets02" => array("name" => "嘴砲王留言板", "link" => "/mysite/nkust-0911/test02"),
        "test03" => array("name" => "我的播放清單", "link" => "/mysite/nkust-0911/test03"),
